                ...
                <form action="{{ route('add.book') }}" autocomplete="on" method="post">
                    ...
                    <table class="table">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="isbn" id="isbn" class="form-control"
                                    placeholder="Masukkan ISBN buku" required /><br>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="judul" id="judul" class="form-control"
                                    placeholder="Masukkan judul buku" required /><br>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="pengarang" id="pengarang" class="form-control"
                                    placeholder="Masukkan nama pengarang buku" required /><br>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="penerbit" id="penerbit" class="form-control"
                                    placeholder="Masukkan nama penerbit buku" required /><br>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="kota" id="kota" class="form-control"
                                    placeholder="Masukkan kota penerbit buku" required /><br>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="editor" id="editor" class="form-control"
                                    placeholder="Masukkan nama editor buku" required /><br>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="stok" id="stok" class="form-control"
                                    placeholder="Masukkan jumlah stok buku" required /><br>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <a class="btn btn-secondary ms-2 m-1" style="float: right"
                            href="{{ route('view.books') }}">Kembali</a>
